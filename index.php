...
<html>
    ...
    <body>
        ...
        <div class="info" style="height: 30px; width: 100%">
            ...
            <div class="inforight" style="height: 30px; width: 84%; padding-top:3px; float: left; background-color: white; color: black">
        ...
        <div class="container table-responsive">
            ...
            <?php
                ...
                $sql = "select id, name, review from review order by id desc limit 5";//ORDER BY id desc
        ...
        <footer style="padding-right: 60px; padding-top: 10px; color: darkgray; text-align: right">
            <p style="font-family: cursive">Designed & Developed by: Md Zakir Hossain bhuiyan</p>
        </footer>
    </body>
</html>