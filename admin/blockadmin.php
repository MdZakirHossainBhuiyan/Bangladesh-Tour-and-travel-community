...
<html lang="en">
    ...
    <body>
        ...
        <div class="container table-responsive">
            <h1 class="text-primary text-center" style="font-size: 20px; font-style: italic; padding-top:30px">----- Admin List -----</h1>
            ...
            <?php
                ...
                $sql = "select * from admin order by id";//ORDER BY id desc
                            ...
                            echo "<table class='table'>";
                                ...
                                while($row = mysqli_fetch_assoc($result))
                                {
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            ?>
                                            <a href="blockadmin.php?del=<?php echo $row["id"];?>" style="text-align: right; font-family: cursive" class="btn text-danger">Delete</a>
                                            <?php
                                        echo "</td>";
                                    echo "</tr>";
                                }
